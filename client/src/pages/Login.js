        ...
        <div className="flex flex-col w-full max-w-md p-12 space-y-4 text-center bg-gray-50 text-gray-800 mx-auto">
            ...
            <form onSubmit={handleSubmit} noValidate="" className="space-y-4 ng-untouched ng-pristine ng-valid">
                <div className="flex flex-col space-y-5 ">
                    ...
                    })} id="email" type="email" placeholder="Email address" className="rounded-t-md border border-gray-400 bg-gray-50 text-gray-800 focus:red-600 focus:border-red-600 focus:ring-2 p-3" />
                    <label htmlFor="password" className="sr-only">Password</label>
                    <input required
                        value={cred.password} onChange={(e) => setcred({
                            ...cred,
                            password: e.target.value
                        })} id="password" type="password" placeholder="Password" className="-mt-1 rounded-b-md border border-gray-400 bg-gray-50 text-gray-800 focus:ring-red-600 focus:border-red-600 focus:ring-2 p-3" />
                </div>
                ...
                <button type="submit" className="px-8 py-3 space-x-2 font-semibold rounded bg-red-600 text-gray-50">Login</button>
            </form>
        </div>
    )
}
