    ...
    return (
        <>
            ...
            <div className="conatiner p-2 mx-auto sm:p-4 text-gray-800">
                <h2 className="mb-4 text-center md:text-left text-2xl font-semibold leading-tight">Main</h2>
                <ul className='list-none mx-auto md:mx-0 flex flex-row w-80 justify-evenly text-center items-center font-semibold m-3'>Sort by Date:
                    <li className='cursor-pointer border rounded-xl shadow-lg p-1 border-red-500 bg-red-600 text-white' onClick={() => sort(1)}>Oldest</li>
                    <li className='cursor-pointer border rounded-xl shadow-lg p-1 border-red-500 bg-red-600 text-white' onClick={() => sort(-1)}>Newest</li>
                </ul>
